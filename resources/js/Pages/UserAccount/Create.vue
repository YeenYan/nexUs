    ...
    <HomeMainLayout>
        <template #nav>
            <div class="nav__wrapper">
                ...
                <Link :href="route('login')" class="btn btn-ghost btn-login"
                    >Log in</Link
                >
            </div>
        </template>
